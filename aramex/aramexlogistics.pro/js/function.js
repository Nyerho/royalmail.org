...
$("#trackbtn").click(function() {
    var tid = document.getElementById("tcode").value;
    if (tid == "") {
        document.getElementById("empty-error").style.display = "block";
        document.getElementById("trackinvalid").style.display = "none";
