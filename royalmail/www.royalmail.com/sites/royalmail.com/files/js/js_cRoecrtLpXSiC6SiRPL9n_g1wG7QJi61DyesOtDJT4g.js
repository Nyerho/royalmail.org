...
window.drupalTranslations = {
    "strings": {
        "": {
            "File is too big ({{filesize}}MiB). Max filesize: {{maxFilesize}}MiB.": "The maximum file size is {{maxFilesize}} MB"
        }
    }
};;
/**
    ...
    return t.widget("ui.tooltip", {
        ...
        _removeDescribedBy: function(i) {
            var e = i.data("ui-tooltip-id"),
                ...
                n = t.inArray(e, o); - 1 !== n && o.splice(n, 1), i.removeData("ui-tooltip-id"), (o = String.prototype.trim.call(o.join(" "))) ? i.attr("aria-describedby", o) : i.removeAttr("aria-describedby")
        },
        _create: function() {
            this._on({
                mouseover: "open",
        ...
        _setOption: function(i, e) {
            var o = this;
            this._super(i, e), "content" === i && t.each(this.tooltips, (function(t, i) {
        ...
        _disable: function() {
            ...
            t.each(this.tooltips, (function(e, o) {
                ...
                var i = t(this);
                if (i.is("[title]")) return i.data("ui-tooltip-title", i.attr("title")).removeAttr("title")
            })))
        },
        _enable: function() {
        ...
        open: function(i) {
            ...
            o.length && !o.data("ui-tooltip-id") && (o.attr("title") && o.data("ui-tooltip-title", o.attr("title")), o.data("ui-tooltip-open", !0), i && "mouseover" === i.type && o.parents().each((function() {
                var i, o = t(this);
                o.data("ui-tooltip-open") && ((i = t.Event("blur")).target = i.currentTarget = this, e.close(i, !0)), o.attr("title") && (o.uniqueId(), e.parents[this.id] = {
                    element: this,
                    title: o.attr("title")
                }, o.attr("title", ""))
            })), this._registerCloseHandlers(i, o), this._updateContent(o, i))
        },
        _updateContent: function(t, i) {
            var e, o = this.options.content,
                n = this,
                s = i ? i.type : null;
            if ("string" == typeof o || o.nodeType || o.jquery) return this._open(i, t, o);
        ...
        _open: function(i, e, o) {
            var n, s, l, a, r = t.extend({}, this.options.position);

            function d(t) {
                r.of = t, s.is(":hidden") || s.position(r)
            }
            o && ((n = this._find(e)) ? n.tooltip.find(".ui-tooltip-content").html(o) : (e.is("[title]") && (i && "mouseover" === i.type ? e.attr("title", "") : e.removeAttr("title")), n = this._tooltip(e), s = n.tooltip, this._addDescribedBy(e, s.attr("id")), s.find(".ui-tooltip-content").html(o), this.liveRegion.children().hide(), (a = t("<div>").html(s.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"), a.removeAttr("id").find("[id]").removeAttr("id"), a.appendTo(this.liveRegion), this.options.track && i && /^mouse/.test(i.type) ? (this._on(this.document, {
                mousemove: d
            }), d(i)) : s.position(t.extend({ of: e
            }, this.options.position)), s.hide(), this._show(s, this.options.show), this.options.track && this.options.show && this.options.show.delay && (l = this.delayedShow = setInterval((function() {
                s.is(":visible") && (d(r.of), clearInterval(l))
            }), 13)), this._trigger("open", i, {
                tooltip: s
            })))
        },
        _registerCloseHandlers: function(i, e) {
            var o = {
                keyup: function(i) {
            ...
            e[0] !== this.element[0] && (o.remove = function() {
                var t = this._find(e);
                t && this._removeTooltip(t.tooltip)
            }), i && "mouseover" !== i.type || (o.mouseleave = "close"), i && "focusin" !== i.type || (o.focusout = "close"), this._on(!0, e, o)
        },
        close: function(i) {
            var e, o = this,
            ...
            })), n.removeData("ui-tooltip-open"), this._off(n, "mouseleave focusout keyup"), n[0] !== this.element[0] && this._off(n, "remove"), this._off(this.document, "mousemove"), i && "mouseleave" === i.type && t.each(this.parents, (function(i, e) {
                t(e.element).attr("title", e.title), delete o.parents[i]
            })), s.closing = !0, this._trigger("close", i, {
                tooltip: e
        ...
        _tooltip: function(i) {
            ...
            return this._addClass(o, "ui-tooltip-content"), this._addClass(e, "ui-tooltip", "ui-widget ui-widget-content"), e.appendTo(this._appendTo(i)), this.tooltips[n] = {
                element: i,
                tooltip: e
            }
        },
        ...
        _destroy: function() {
            ...
            t.each(this.tooltips, (function(e, o) {
                var n = t.Event("blur"),
                    s = o.element;
                n.target = n.currentTarget = s[0], i.close(n, !0), t("#" + e).remove(), s.data("ui-tooltip-title") && (s.attr("title") || s.attr("title", s.data("ui-tooltip-title")), s.removeData("ui-tooltip-title"))
