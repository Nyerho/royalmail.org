//tealium universal tag - utag.557 ut4.0.202605011123, Copyright 2026 Tealium.com Inc. All Rights Reserved.
var dotq = dotq || [];
try {
    (function(id, loader) {
        var u = {
        ...
        u.send = function(utag_event, data_layer) {
            if (u.ev[utag_event] || u.ev.all !== undefined) {
                ...
                utag.DB("send:557:COMPLETE");
            }
        };

        function loaderCallback() {
            utag.DB("send:557:CALLBACK");
            u.initialized = true;
            if (u.data.pixelId) {
            ...
            utag.DB("send:557:CALLBACK:COMPLETE");
        }
