//tealium universal tag - utag.527 ut4.0.202605011042, Copyright 2026 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {};
                ...
                for (d in utag.loader.GV(u.map)) {
                    if (b[d] !== undefined && b[d] !== "") {
                        ...
                        for (f = 0; f < e.length; f++) {
                            if (/^(cat|multicat|type|src|cost|qty|ord|order_id|order_subtotal|product_id|product_quantity|product_unit_price)$/.test(e[f])) {
                                u.data[e[f]] = b[d];
                            } else {
                                u.data[e[f]] = b[d];
