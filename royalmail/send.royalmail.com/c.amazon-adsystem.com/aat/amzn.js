/* Use of this pixel is subject to the Amazon ad specs and policies at http://www.amazon.com/b/?&node=7253015011. Version number: 6, Changeset: Adding in phone number support for setUserData */ ! function() {
    ...
    function N(e, t, n) {
        ...
        if (n || "EU" === t || o) return function(e, t) {
            ...
            const n = d.getMeasurementTokenTimestamp(),
                o = d.measurementTokenTimestampPairsNestedArrToMeasurementTokenCookie([
                    [t, n]
                ]);
        ...
        A.MEASUREMENT_TOKEN_FULLY_ENABLED_REGIONS.includes(t) && function(e, t, n) {
            ...
            if (t) {
                ...
                if (r) {
                    const n = d.measurementTokenCookieToMeasurementTokenTimestampPairsNestedArr(r),
                        s = n.some((([e]) => e === t)) ? [e, ...n.filter((([e]) => e !== t))] : [e, ...n];
                    r = d.measurementTokenTimestampPairsNestedArrToMeasurementTokenCookie(s), o = "cookie"
                } else r = d.measurementTokenTimestampPairsNestedArrToMeasurementTokenCookie([e]), o = "cookie"
            } else r && (o = "cookie");
            r = function(e) {
                if (!e) return;
                const t = d.getMeasurementTokenTimestamp() - A.MEASUREMENT_TOKEN_TTL_IN_MS,
                    n = d.measurementTokenCookieToMeasurementTokenTimestampPairsNestedArr(e).filter((([, e]) => e > t));
                return n.length > 0 ? d.measurementTokenTimestampPairsNestedArrToMeasurementTokenCookie(n) : void 0
    ...
    var l = {
        createQueryParams: function(e, {
            ...
            const E = "string" == typeof e ? new URL(e) : e;
            if (d.isEmpty(t)) throw new Error("Tag ID is a required parameter.");
            if (!d.isValidAdTag(t)) throw new Error("Invalid ad tag provided.");
            if (E.searchParams.set("pid", t), d.isEmpty(n)) throw new Error("Event name is a required parameter.");
            E.searchParams.set("event", n), Array.isArray(o) && u(E, "items", encodeURI(JSON.stringify(o))), o && Object.entries(o).forEach((([e, t]) => {
                A.GDPR_VALUES.includes(e) || (t || "" === t) && ("object" == typeof t ? E.searchParams.set(e, JSON.stringify(t)) : E.searchParams.set(e, String(t)))
            })), r && A.GDPR_VALUES.forEach((e => {
                r[e] && E.searchParams.set(e, r[e])
            }));
            let c = "EU" === i || "UK" === i,
                _ = null;
            a && (_ = JSON.stringify(a), E.searchParams.set(A.AIPES_AMAZON_CONSENT_STRING_FIELD_NAME, _), "{}" !== _ && '"null"' !== _ && "undefined" !== _ && (c = !0));
            const l = new T;
            if (l.isCookiePresent(A.AMZN_TOKEN_COOKIE_NAME)) {
                const e = l.getCookieValue(A.AMZN_TOKEN_COOKIE_NAME);
                e && u(E, A.AMZN_TOKEN_URL_QUERY_PARAM_NAME, e)
            }
            return N(E, i, c ? _ : null), E.searchParams.set("eventSource", "amzn.js"), s && E.searchParams.set("uuid", s), E
        }
    };
    const {
        createQueryParams: m
    ...
    H.prototype.addTag = function({
        ...
        try {
            await async function({
                ...
                let T;
                try {
                    const e = a.getFormattedAmazonConsent(!1);
                    e && e.geo && e.geo.countryCode && (T = e.geo.countryCode)
                } catch (e) {
                    console.warn("Error extracting consent country code:", e)
                }
                const d = P(new URL(e), {
                    tagId: r,
                    eventName: o,
        ...
        e && "string" == typeof e ? this.countryCode = e.toUpperCase() : console.warn("Invalid country code provided")
    ...
    j.prototype.saveMeasurementTokenInURLToCookieIfPresent = function(e, t) {
        try {
    ...
    }, j.prototype.removeAnyExpiredMeasurementTokens = function() {
        try {
    ...
    }, j.prototype.formatRequestBody = function(e) {
        const t = {};
    ...
    }, j.prototype.requestAmznToken = async function(e) {
        const t = { ...x,
        ...
        throw Error(o)
    }, j.prototype.renewAmznToken = async function(e) {
        if (!this.cookieHandler.isCookiePresent(F.AMZN_TOKEN_COOKIE_NAME) && !this.cookieHandler.isCookiePresent(F.NO_CONSENT_COOKIE_NAME)) try {
            ...
            return "" === n[B] ? this.cookieHandler.writeCookie(F.NO_CONSENT_COOKIE_NAME, n[B], n[W]) : this.cookieHandler.writeCookie(F.AMZN_TOKEN_COOKIE_NAME, n[B], n[W]), n
        } catch (e) {
            console.error(e)
        }
        return "no-op"
    }, j.prototype.deleteAmznToken = async function() {
    ...
    }, j.prototype.updateAmznToken = async function(e) {
    ...
    ne.prototype.processCommandQueue = async function(e) {
        ...
        if ("EU" === t) try {
            this.eventTracker.setRegion("EU"), console.log("[AAT] Region explicitly set to EU");
            try {
                this.tokensHandler.saveMeasurementTokenInURLToCookieIfPresent("EU", !0)
            } catch (e) {
        ...
        try {
            ...
            console.log("[AAT] CSP blocked fetch → setting region to UNKNOWN for GDPR safety"), o = !0
        }
        let r = null,
            s = !1;
        try {
            if (this.consentHandler && this.consentHandler.isConsentSet()) {
                ...
                e && e.geo && e.geo.countryCode && (r = e.geo.countryCode)
            }
        } catch (e) {
            console.warn("[AAT] Error checking Amazon consent or getting country code:", e)
        }
        let a = t;
        n && ee(n) && (a = "EU"), r && ee(r) && (a = "EU"), o && "EU" !== a && (a = "EU");
        try {
            this.eventTracker.setRegion(a)
        } catch (e) {
            console.warn("[AAT] Error setting region in event tracker:", e)
        }
        try {
            this.tokensHandler.saveMeasurementTokenInURLToCookieIfPresent(a, s)
        } catch (e) {
            console.warn("Error saving measurement token in URL to cookie:", e)
        }
    ...
    !async function() {
        ...
        try {
            ...
            e && (n.setCountryCode(e), de.isEUCountry(e) && (n.setRegion("EU"), console.log("[AAT] Setting region to EU based on country code")))
        } catch (e) {
