//tealium universal tag - utag.989 ut4.0.202605010910, Copyright 2026 Tealium.com Inc. All Rights Reserved.
(function(f) {
    if (f.fbq) return;
...
try {
    (function(id, loader) {
        ...
        u.map = {
            "fb_custom_event:Purchase - Keepsafe": "Purchase - Keepsafe",
            "fb_custom_event:Purchase - Redirection": "Purchase - Redirection",
            "fb_custom_event:Lead": "Lead",
            "fb_custom_event:Custom": "Custom",
            "transactionCurrency": "custom.currency",
            "transactionTotal": "custom.value",
            ...
            try {
                if (1) {
                    if (b.fb_custom_event) {
                        if (a !== 'view' || !b.transactionTotal || !b.transactionCurrency) {
                            return false;
                        }
                    }
                }
            ...
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                if (u.data.generate_event_id === "true" || u.data.generate_event_id === true) {
                    ...
                    if (typeof lookup_id !== "undefined") {
                        ...
                        utag.DB("send:989: The tealium_random variable was not defined. Any Facebook event IDs generated will not be collected by Tealium Collect. Please ensure you are using the latest version of utag.js to generate a tealium_random value.");
                    }
                }
                ...
                for (i = 0; i < u.data.event_queue.length; i++) {
                    ...
                    if (u.data.generate_event_id === "true" || u.data.generate_event_id === true) {
                        if (b.tealium_random) {
                            event_id = u.generateEventID(event_name_underscores, b, lookup_id);
                            ...
                            utag.DB("send:989: Event ID Generation is enabled, but the tealium_random value was not found in the data layer. No event ID was generated for " + event_name);
                        }
                        ...
                        for (key in standard_events_lookup[event_name].req_params) {
                            if (standard_events_lookup[event_name].req_params.hasOwnProperty(key)) {
                                if (!event_data[standard_events_lookup[event_name].req_params[key]]) {
                                    utag.DB("send:989:" + event_name + " tracking: The required parameter '" + standard_events_lookup[event_name].req_params[key] + "' is empty. ");
                                    continue;
                                }
                            }
                        }
