//tealium universal tag - utag.965 ut4.0.202605010910, Copyright 2026 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {
            "id": id
        ...
        u.getRemarketingItems = function() {
            var i, item = {},
                ...
                rmkt = u.data.rmkt,
                len = 0,
                verticalName, vertical, paramName;
        ...
        u.map = {
            "gads_conversion_id": "conversion_id",
            "gads_conversion_label": "conversion_label",
            "gads_conversion_page_type": "pagetype"
        };
        u.extend = [];
        u.send = function(a, b) {
