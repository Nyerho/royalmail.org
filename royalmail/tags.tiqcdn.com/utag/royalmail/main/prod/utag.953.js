//tealium universal tag - utag.953 ut4.0.202605010910, Copyright 2026 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {
            "id": id
        ...
        u.map = {
            "tealium_visitor_id_hash": "config.user_id"
        };
        u.extend = [];
        u.send = function(a, b) {
