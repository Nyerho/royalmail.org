//tealium universal tag - utag.560 ut4.0.202605011123, Copyright 2026 Tealium.com Inc. All Rights Reserved.
(function(f) {
    if (f.fbq) return;
            ...
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                if (u.data.generate_event_id === "true" || u.data.generate_event_id === true) {
                    ...
                    if (typeof lookup_id !== "undefined") {
                        ...
                        utag.DB("send:560: The tealium_random variable was not defined. Any Facebook event IDs generated will not be collected by Tealium Collect. Please ensure you are using the latest version of utag.js to generate a tealium_random value.");
                    }
                }
                ...
                for (i = 0; i < u.data.event_queue.length; i++) {
                    ...
                    if (u.data.generate_event_id === "true" || u.data.generate_event_id === true) {
                        if (b.tealium_random) {
                            ...
                            utag.DB("send:560: Event ID Generation is enabled, but the tealium_random value was not found in the data layer. No event ID was generated for " + event_name);
                        }
                        ...
                        for (key in standard_events_lookup[event_name].req_params) {
                            if (standard_events_lookup[event_name].req_params.hasOwnProperty(key)) {
                                if (!event_data[standard_events_lookup[event_name].req_params[key]]) {
                                    utag.DB("send:560:" + event_name + " tracking: The required parameter '" + standard_events_lookup[event_name].req_params[key] + "' is empty. ");
                                    continue;
                                }
                            }
                        }
                ...
                if (!u.scriptrequested) {
                    ...
                    ! function(t, r) {
                        ...
                        t.r(r), t.d(r, {
                            getFbc: () => S,
                            getFbp: () => k,
                            processAndCollectAllParams: () => C,
                            processAndCollectParams: () => R
                        });
                        var e = 999999999,
                            n = 7776e6,
                            o = "fb",
                        ...
                        function d(t, r, e) {
                            return [o, t, r, e, h].join(".")
                        }

                        function v(t, r) {
                            var e = new RegExp("[?#&]" + r.replace(/[\[\]]/g, "\\$&") + "(=([^&#]*)|&|#|$)").exec(t);
                        ...
                        function g(t) {
                            var r = [];
                            try {
                                for (var e = document.cookie.split(";"), n = "^\\s*".concat(t, "=\\s*(.*?)\\s*$"), o = new RegExp(n), i = 0; i < e.length; i++) {
                                    var a = e[i].match(o);
                                    a && r.push(a[1])
                                }
                        ...
                        function w(t, r, e) {
                            var o, i, a, u, c, l, f = (o = n, new Date(Date.now() + Math.round(o)).toUTCString());
                            if ("string" == typeof t && "string" == typeof r && "string" == typeof e) try {
                                var s = encodeURIComponent(r);
                                document.cookie = "".concat(t, "=").concat(s, ";") + "expires=".concat(f, ";") + "domain=.".concat(e, ";") + "".concat((i = window.chrome, u = (a = window.navigator).vendor, c = void 0 !== window.opr, l = a.userAgent.indexOf("Edg") > -1, a.userAgent.match("CriOS") || null == i || "Google Inc." !== u || !1 !== c || !1 !== l ? "" : "SameSite=Lax;")) + "path=/"
                            } catch (t) {
                        ...
                        function b(t) {
                            ...
                            return "string" != typeof r || "" === r ? null : function(t) {
                                var r = t.split(".");
                                if (r.length !== f && r.length !== s) return null;
                                var e, n, i = (n = 5, function(t) {
                                    ...
                                    l = i[3],
                                    h = i[4];
                                if (null != h && !p.includes(h)) return null;
                                if (a !== o) return null;
                                var d = parseInt(u, 10);
                                ...
                                var g = {};
                                return g.creationTime = v, g.payload = l, g.subdomainIndex = d, g.languageToken = h, g
                            }(r)
                        }

                        function x(t, r) {
                            for (var e = window.location.hostname.split("."), n = 0; n < e.length; n++) {
                                var o = m(e, n),
                                    i = d(n, (new Date).getTime(), r);
                                if (w(t, i, o), "" !== g(t)) return i
                            }
                            return null
                        }
                        ...
                        function L(t, r) {
                            ...
                            var n = m(e, r.subdomainIndex),
                                o = d(r.subdomainIndex, r.creationTime, r.payload);
                            return w(t, o, n), o
                        }
                        ...
                        function O() {
                            var t = v(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : window.location.href, i);
                            if (null === t && (t = v(document.referrer, i)), null != t && t.length > 500) return null;
                            var r = b(a);
                            if (null != t) {
                                if (null == r) return x(a, t);
                                var e = function(t, r) {
                                    if (null === t || t.payload !== r) {
                                        var e = {};
                                        e.payload = r;
                                        var n = Date.now();
                                        return e.creationTime = "number" == typeof n ? n : (new Date).getTime(), e.subdomainIndex = t.subdomainIndex, e
                                    }
                                    return t
                                }(r, t);
                                return L(a, e)
                            }
                            return null != r ? L(a, r) : r
                        }

                        function j() {
                            var t = b(c);
                            if (null != t) return L(c, t);
                            var r = E();
                            return x(c, r)
                        }
                        ...
                        function P() {
                            ...
                            function j(t, r) {
                                function e(o, i, a, u) {
                                    ...
                                    if ("throw" !== c.type) {
                                        var l = c.arg,
                                            f = l.value;
                                        return f && "object" == _(f) && n.call(f, "__await") ? r.resolve(f.__await).then((function(t) {
                                            e("next", t, a, u)
                                        }), (function(t) {
                                            e("throw", t, a, u)
                            ...
                            function k(r, e) {
                                var n = e.method,
                                    o = r.iterator[n];
                                if (o === t) return e.delegate = null, "throw" === n && r.iterator.return && (e.method = "return", e.arg = t, k(r, e), "throw" === e.method) || "return" !== n && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + n + "' method")), v;
                                var i = s(o, r.iterator, e.arg);
                                if ("throw" === i.type) return e.method = "throw", e.arg = i.arg, e.delegate = null, v;
                                var a = i.arg;
                                return a ? a.done ? (e[r.resultName] = a.value, e.next = r.nextLoc, "return" !== e.method && (e.method = "next", e.arg = t), e.delegate = null, v) : a : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, v)
                            }
                            ...
                            function N(r) {
                                ...
                                throw new TypeError(_(r) + " is not iterable")
                            }
                            return m.prototype = w, o(E, "constructor", {
                                ...
                                value: m,
                                configurable: !0
                            }), m.displayName = l(w, c, "GeneratorFunction"), r.isGeneratorFunction = function(t) {
                                var r = "function" == typeof t && t.constructor;
                                return !!r && (r === m || "GeneratorFunction" === (r.displayName || r.name))
                            }, r.mark = function(t) {
                                return Object.setPrototypeOf ? Object.setPrototypeOf(t, w) : (t.__proto__ = w, l(t, c, "GeneratorFunction")), t.prototype = Object.create(E), t
                            }, r.awrap = function(t) {
                                return {
                                    __await: t
                                }
                                ...
                                void 0 === i && (i = Promise);
                                var a = new j(f(t, e, n, o), i);
                                return r.isGeneratorFunction(e) ? a : a.next().then((function(t) {
                                    return t.done ? t.value : a.next()
                                }))
                            }, O(E), l(E, c, "Generator"), l(E, a, (function() {
                                return this
                        ...
                        function N() {
                            return (N = T(P().mark((function t() {
                                var r, e;
                                return P().wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                            if (!0 !== (null != window.webkit && null != window.webkit.messageHandlers && null != window.webkit.messageHandlers.browserProperties)) {
                                                t.next = 6;
                                                break
                                            }
                                            return t.next = 4, window.webkit.messageHandlers.browserProperties.postMessage("clickID");
                                        case 4:
                                            return r = t.sent, t.abrupt("return", r);
                                        case 6:
                                            if (!0 !== (n = 397, o = void 0, i = void 0, a = void 0, u = void 0, c = void 0, l = void 0, o = window.navigator.userAgent, i = o.indexOf("Android") >= 0, a = o.indexOf("FB_IAB") >= 0, u = o.indexOf("Instagram") >= 0, c = function(t) {
                                                    var r = 0,
                                                        e = t.match(/(FBAV|Instagram)[/\s](\d+)/);
                                                    if (null != e) {
                                                        var n = e[0].match(/(\d+)/);
                                                        null != n && (r = parseInt(n[0], 10))
                                                    }
                                                    return r
                                                }(o), !!(l = i && (a || u)) && (a && null != n ? n <= c : u && null != instagramVersionReq ? instagramVersionReq <= c : l) && void 0 !== window.XMLHttpRequest)) {
                                                t.next = 12;
                                                break
                                            }
                                            return t.next = 10, new Promise((function(t, r) {
                                                var e = new window.XMLHttpRequest;
                                                e.open("GET", "properties://browser/clickID"), e.onload = function() {
                                                    e.readyState === e.DONE && e.status >= 200 && e.status < 300 && e.responseText && t(e.responseText)
                                                }, e.onerror = function() {
                        ...
                        function F() {
                            return (F = T(P().mark((function t(r) {
                                var e, n, o, i, u;
                                return P().wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                        ...
                                        case 9:
                                            (u = t.sent) && (x(a, u), e = !0);
                                        case 11:
                                            return i && "" != i || (x(c, E()), n = !0), t.abrupt("return", e || n);
                                        case 13:
                                        case "end":
                                            return t.stop()
                                    }
                        ...
                        function B() {
                            ...
                            function j(t, r) {
                                function e(o, i, a, u) {
                                    ...
                                    if ("throw" !== c.type) {
                                        var l = c.arg,
                                            f = l.value;
                                        return f && "object" == M(f) && n.call(f, "__await") ? r.resolve(f.__await).then((function(t) {
                                            e("next", t, a, u)
                                        }), (function(t) {
                                            e("throw", t, a, u)
                                        })) : r.resolve(f).then((function(t) {
                            ...
                            function T(r) {
                                ...
                                throw new TypeError(M(r) + " is not iterable")
                            }
                            return m.prototype = w, o(E, "constructor", {
                                value: w,
                                configurable: !0
                                ...
                                constructor: I,
                                reset: function(r) {
                                    if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(P), !r)
                                        for (var e in this) "t" === e.charAt(0) && n.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = t)
                                },
                                stop: function() {
                                    this.done = !0;
                        ...
                        function R(t) {
                            var r = {},
                                e = O(t),
                                n = j();
                            return null != e && (r[u] = e), null != n && (r[l] = n), r
                        }
                        ...
                        function H() {
                            var t;
                            return t = B().mark((function t(r) {
                                var e;
                                return B().wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                            return e = {}, O(r), j(), t.next = 5, G(!0);
                                        case 5:
                                            return t.sent, e[u] = S(), e[l] = k(), t.abrupt("return", e);
                                        case 9:
                                        case "end":
                                            return t.stop()
                                    }
                ...
                utag.DB("send:560:COMPLETE");
            }
        };
        utag.o[loader].loader.LOAD(id);
    }("560", "royalmail.sendanitem"));
} catch (error) {
    utag.DB(error);
}